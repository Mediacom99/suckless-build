...
/* Custom colors -- Catppuccin Theme and Colors*/
static const char *colorname[] = {
    "#494D64", 
    "#ED8796", 
    "#A6DA95", 
...
unsigned int defaultfg = 256; /*258*/
unsigned int defaultbg = 257; /*259*/
unsigned int defaultcs = 258; /*258*/
static unsigned int defaultrcs = 258; /*257*/
